        ...
        <div className={styles.contenedor}>
          ...
          <div className={styles.seccion}>
            <p className={styles.texto}>
              Bienvenido a RentManager. Al acceder y utilizar nuestra plataforma, aceptas cumplir con 
              estos Términos de Servicio. Por favor, léelos cuidadosamente antes de usar nuestros servicios.
            </p>
          </div>

          <h2 className={styles.subtitulo}>1. Aceptación de los Términos</h2>
          <p className={styles.texto}>
            Al registrarte y utilizar RentManager, aceptas estar legalmente vinculado por estos términos. 
          ...
          <p className={styles.texto}>
            RentManager proporciona una plataforma web para la gestión de propiedades en arriendo, 
          ...
          <p className={styles.texto}>
            Para utilizar RentManager debes:
          </p>
          <ul className={styles.lista}>
          ...
          <p className={styles.texto}>
            Todos los derechos de propiedad intelectual sobre RentManager, incluyendo software, diseño, 
            contenido y marca, pertenecen exclusivamente a RentManager y están protegidos por las leyes 
            de propiedad intelectual aplicables.
          </p>

          <h2 className={styles.subtitulo}>6. Privacidad y Protección de Datos</h2>
          <p className={styles.texto}>
            El uso de tus datos personales está regulado por nuestra Política de Privacidad. Al utilizar 
            RentManager, aceptas el tratamiento de tus datos conforme a dicha política.
          </p>

          <h2 className={styles.subtitulo}>7. Facturación y Pagos</h2>
          <ul className={styles.lista}>
            <li>Los pagos se procesan de forma mensual o anual según el plan seleccionado</li>
            <li>Las renovaciones son automáticas salvo cancelación previa</li>
            <li>No se realizan reembolsos parciales por cancelaciones anticipadas</li>
          ...
          <p className={styles.texto}>
            RentManager se reserva el derecho de suspender o cancelar cuentas que violen estos términos. 
            Los usuarios pueden cancelar su suscripción en cualquier momento desde el panel de configuración.
          </p>

          <h2 className={styles.subtitulo}>9. Limitación de Responsabilidad</h2>
          <p className={styles.texto}>
            RentManager no será responsable por daños indirectos, incidentales o consecuentes derivados 
            del uso o imposibilidad de uso de la plataforma. Nuestro servicio se proporciona "tal cual" 
            sin garantías de ningún tipo.
          </p>

          <h2 className={styles.subtitulo}>10. Modificaciones</h2>
          <p className={styles.texto}>
            RentManager se reserva el derecho de modificar estos términos en cualquier momento. Los cambios 
          ...
          <p className={styles.texto}>
            ...
            resolverá en los tribunales competentes de Bogotá D.C.
          </p>

          <div className={styles.contacto}>
            <h3>Contacto Legal</h3>
            <p>Para consultas sobre estos términos:</p>
            <p><strong>legal@rentmanager.com</strong></p>
          </div>
        </div>
      </div>
      <Footer />
